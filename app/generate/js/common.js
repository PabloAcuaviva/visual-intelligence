class Grid {
    constructor(height, width, values) {
        ...
        if (isNaN(this.height) || this.height <= 0) {
            // console.warn('Invalid height passed to Grid constructor, defaulting to 1:', height);
            this.height = 1; // Default to a minimal valid grid
        }
        if (isNaN(this.width) || this.width <= 0) {
            // console.warn('Invalid width passed to Grid constructor, defaulting to 1:', width);
            this.width = 1; // Default to a minimal valid grid
        }
